...
contract NOCT is ERC20 ("Nocturnal Token", "NOCT") {
    ...
    uint256 private _holderIndex = 0;

    NocturnalFinanceInterface public nocturnalFinance;

    constructor(address _nocturnalFinance) public {
        //_cap = 10000000 ether;
        //_mint(address(msg.sender), _cap);
    ...
    function _beforeTokenTransfer(address from, address to, uint256 amount) internal virtual override {
        ...
        if(_isHolder[to] == false) {
            _isHolder[to] = true;
            holders[_holderIndex] = to;
            _holderIndex++;
        }
    ...
    function snapshot() external returns (uint256) {
        require(msg.sender == nocturnalFinance.pickWinnerAddress());
        return _snapshot();
    }
