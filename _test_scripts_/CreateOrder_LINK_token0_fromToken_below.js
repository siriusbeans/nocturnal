...
contract('CreateOrder_LINK_token0_fromToken_below', accounts => {
    ...
    const fromTokenAddress = LINK; 
    const toTokenAddress = WETH; 
...
//=============================================================================================//    
    ...
    describe("tests new order creation", async () => {
        ...
        // create a new order
        createOrder(fromTokenBalance1, false, amountOutMin1, accounts[0]);
